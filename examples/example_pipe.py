...
for ii in range(3):
    ...
    block_path = '/export/scratch2/kostenko/archive/Natrualis/pitje/femur/high_res/flipped_orientation/block_%u/'%(ii+1)
    pipe.add_data(path = block_path + 't1')
    pipe.add_data(path = block_path + 't2')
